...
const serverRegExp = /server:(.+)/; // Добавим регулярное выражение для серверов
...
module.exports = (bot) => {
	...
	bot.callbackQuery(serverRegExp, serversService.getServer); // Обрабатываем колбэк серверов
};
